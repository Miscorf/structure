...
typedef enum
{
    ...
    INVALID_FILE,
    SPILASH_ERASE_FAILED,
    CORRUPT_FIRMWARE_IMAGE_FILE,
    I2CE2PROM_UNKNOWN_I2C_SIZE
} FX3_FWDWNLOAD_ERROR_CODE;

#define CYWB_BL_4_BYTES_COPY(destination, source)           \
    {                                                       \
        memcpy((void *)(destination), (void *)(source), 4); \
    }
